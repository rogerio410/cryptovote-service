...
func (x *VoteRequest) Reset() {
	*x = VoteRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_voteservice_service_proto_msgTypes[0]
...
func (*VoteRequest) Descriptor() ([]byte, []int) {
	return file_voteservice_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *VoteResponse) Reset() {
	*x = VoteResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_voteservice_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VoteResponse) Descriptor() ([]byte, []int) {
	return file_voteservice_service_proto_rawDescGZIP(), []int{1}
}
...
var file_voteservice_service_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x25, 0x0a, 0x0b, 0x56, 0x6f, 0x74, 0x65,
	...
	0x2a, 0x0a, 0x0c, 0x56, 0x6f, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x1a, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x91, 0x01, 0x0a, 0x0b,
	0x56, 0x6f, 0x74, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3f, 0x0a, 0x06, 0x55,
...
var (
	file_voteservice_service_proto_rawDescOnce sync.Once
	file_voteservice_service_proto_rawDescData = file_voteservice_service_proto_rawDesc
)

func file_voteservice_service_proto_rawDescGZIP() []byte {
	file_voteservice_service_proto_rawDescOnce.Do(func() {
		file_voteservice_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_voteservice_service_proto_rawDescData)
	})
	return file_voteservice_service_proto_rawDescData
}

var file_voteservice_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_voteservice_service_proto_goTypes = []interface{}{
	(*VoteRequest)(nil),  // 0: voteservice.VoteRequest
	(*VoteResponse)(nil), // 1: voteservice.VoteResponse
}
var file_voteservice_service_proto_depIdxs = []int32{
	0, // 0: voteservice.VoteService.UpVote:input_type -> voteservice.VoteRequest
	0, // 1: voteservice.VoteService.DownVote:input_type -> voteservice.VoteRequest
	1, // 2: voteservice.VoteService.UpVote:output_type -> voteservice.VoteResponse
	1, // 3: voteservice.VoteService.DownVote:output_type -> voteservice.VoteResponse
...
func file_voteservice_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_voteservice_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_voteservice_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		MessageInfos:      file_voteservice_service_proto_msgTypes,
	}.Build()
